---
paper_number: 147
title: "Production-Grade Git and Git Flow"
layer: cross-cutting
domain_profile: version_control
corpus_version: 1.1.0
verified_through: 2026-08-20
...
This paper treats Git, working-tree/index state, object reachability, branching and integration models, pull/merge requests, hosted authorization, CI/CD, signing and provenance, release management, recovery, repository scale, LFS, submodules, monorepos, and policy migrations as related but distinct concerns. A clone does not contain hosted approvals, required-check state, rulesets, merge queues, deployment authorization, or administrative audit. A commit signature does not prove authorization or release approval. A branch name does not identify immutable bytes.
...
## 6. Data, API, and release-contract implications
...
### 7.1. Git objects, commits, trees, refs, and object identifiers
...
### 7.2. Working tree, index, HEAD, and remote state
...
### 7.3. Reachability, ancestry, revision ranges, and diff semantics
...
### 7.4. Filesystem portability, attributes, renames, and worktrees
...
### 7.5. Branching models and release topology
...
### 7.6. Merge, squash, rebase, fast-forward, and cherry-pick
...
### 7.7. Conflicts, sequencers, stash, and dirty state
...
### 7.8. Pull requests, approvals, required checks, and merge queues
...
### 7.9. Ref concurrency, force-with-lease, transactions, and atomic pushes
...
### 7.10. Idempotency, retry classification, ambiguous writes, and consistency
...
### 7.11. Recovery, reflogs, corruption, backups, and application rollback
...
### 7.12. Repository trust, identity, authorization, protected refs, and bypasses
...
### 7.13. Untrusted CI, credentials, runners, workflow dependencies, and OIDC
...
### 7.14. Commit and tag signing, provenance, audit, and release evidence
...
### 7.15. Secrets, sensitive data, branch deletion, and history rewriting
...
### 7.16. Release tags, versioning, artifacts, release branches, and backports
...
### 7.17. Repository scale, maintenance, sparse, partial, and shallow clones
...
### 7.18. Git LFS, submodules, monorepos, and cross-repository changes
...
### 7.19. Default-branch and workflow-policy migrations
...
### 7.20. Agent preflight, authority, testing, metrics, and verification
...
## 10. Common production bugs and AI-agent failure modes
...
## 11. Questions that must be answered before implementation
...
## 12. Existing-codebase checks before changing anything
...
## 13. Operational metrics and evidence
...
## 14. Knowledge graph relationships
...
- [001. Project & Runtime Foundations](../systems/001-project-and-runtime-foundations.md)
- [023. Database Transactions](../primitives/023-database-transactions.md)
- [025. Concurrency Control](../primitives/025-concurrency-control.md)
- [036. Idempotency](../primitives/036-idempotency.md)
- [048. Distributed Transactions](../systems/048-distributed-transactions.md)
- [052. Retry Engineering](../primitives/052-retry-engineering.md)
- [063. Secrets Management](063-secrets-management.md)
- [071. Backward Compatibility](../primitives/071-backward-compatibility.md)
- [076. Backup](076-backup.md)
- [077. Restore](077-restore.md)
- [089. Dependency Management](089-dependency-management.md)
- [090. Testing Foundations](090-testing-foundations.md)
...
- [122. Data Provenance](../primitives/122-data-provenance.md)
- [123. Source of Truth](../primitives/123-source-of-truth.md)
- [124. Data Reconciliation](../primitives/124-data-reconciliation.md)
...
## 15. Sources and further research
